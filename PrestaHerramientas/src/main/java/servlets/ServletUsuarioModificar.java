...
public class ServletUsuarioModificar extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		boolean frecuente = Boolean.parseBoolean(request.getParameter("frecuente"));
		
		
		String usuarioStr = usuario.modificar(username,contrasena,nombre_usu,apellidos,
                        email,saldo,frecuente);
